...
void InitCAN1(void)
{
    ...
    g_sCAN1RxMessage.ui32MsgIDMask = 1;
...
//    g_ui8TXMsgData[] = 0;
    ...
    g_ui8TXMsgData[0] ='S';// 48 + rand() % 10;
    g_ui8TXMsgData[1] ='L'; //48 + rand() % 10;
    g_ui8TXMsgData[2] ='A';//48 + rand() % 10;
    g_ui8TXMsgData[3] ='V';// 48 + rand() % 10;
    g_ui8TXMsgData[4] ='E'; //48 + rand() % 10;
    g_ui8TXMsgData[5] ='1'; //48 + rand() % 10;
    g_ui8TXMsgData[6] ='1'; //48 + rand() % 10;
...
//                    ,g_ui8RXMsgData[4],g_ui8RXMsgData[5],g_ui8RXMsgData[6],g_ui8RXMsgData[7] );// Print the received character to the UART terminal
            ...
            UARTprintf("Message ID: %d Message Data is =:",g_sCAN1RxMessage.ui32MsgID);
