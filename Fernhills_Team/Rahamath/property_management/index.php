  ...
  <div class="top_1 clearfix">
   ...
   <div class="col-sm-6">
    <div class="top_1r pull-right clearfix">
	 <ul>
	  <li><a class="col" href="#"><i class="fa fa-user"></i> Login</a></li>
	  <li><a class="col" href="#"><i class="fa fa-sign-in"></i> Register</a></li>
	...
	<div class="col-sm-4">
	   <div class="serv_home_1i clearfix">
	    <div class="serv_home_1i1 clearfix">
		 ...
		 <p class="col">When you invert you'll earn and when you'll earn you will definately  enjoy.</p>
		 <!-- <h5><a class="col" href="#">Read More <i class="fa fa-long-arrow-right"></i></a></h5> -->
		</div>
		<div class="serv_home_1i2 clearfix">
	...
	<div class="col-sm-4">
	   <div class="serv_home_1i clearfix">
	    <div class="serv_home_1i1 clearfix">
		 ...
		 <p class="col">Learn not only yo earn money but also how to save it.
...
<section id="feature">
 <div class="container">
  <div class="row">
   <div class="feature_1 clearfix">
    <div class="col-sm-12">
	   <h4 class="mgt">RECENT<br><span class="col_1">PROPERTIES</span></h4>
	</div>
   </div>
	  ...
	  ?>
					<div class="col-sm-4">
					 <div class="feature_2im clearfix">
					     ...
					     <a href="#"><img src="<?php echo $image; ?>" class="iw" alt="abc" ></a>
					    </div>
					 ...
					 <div class="feature_2m_last clearfix">
					  ...
					  <h6><i class="fa fa-hotel col_1"></i><?php echo $beds; ?><span class="pull-right"><i class="fa fa-building-o col_1"></i><?php echo $bathrooms; ?></span></h6>
					  <h6><i class="fa fa-object-group col_1"></i><?php echo $area; ?><span class="pull-right"><i class="fa fa-gear col_1"></i><?php echo $parking; ?>Garages</span></h6><br>
					  ...
					  <div class="feature_2m_last_i clearfix">
					    <h6><a href="#"><i class="fa fa-user"></i>User 1<span class="pull-right"><i class="fa fa-calendar"></i> 2 months ago</span></a></h6>
					  </div>
					 </div>
					</div>
					<?php } ?>
					<!-- <div class="col-sm-4">
					 ...
					 <div class="feature_2m_last clearfix">
					  ...
					  <p><i class="fa fa-map-marker"></i>Udupi</p><br>
					...
					<div class="col-sm-4">
					 ...
					 <div class="feature_2m_last clearfix">
					  ...
					  <p><i class="fa fa-map-marker"></i>Mysore</p><br>
					  <h6><i class="fa fa-hotel col_1"></i> 4 Bedrooms <span class="pull-right"><i class="fa fa-building-o col_1"></i> 3 Bathrooms</span></h6>
					  <h6><i class="fa fa-object-group col_1"></i> 620 sq ft <span class="pull-right"><i class="fa fa-gear col_1"></i> 2 Garages</span></h6><br>
					  <h5 class="bold"><a href="#">&#8377; 130,000 <span class="pull-right"><i class="fa fa-exchange"></i> <i class="fa fa-share-alt"></i> <i class="fa fa-heart-o"></i></span></a></h5>
					  <div class="feature_2m_last_i clearfix">
                ...
                <div class="item">
                    <div class="col-sm-4">
					 ...
					 <div class="feature_2m_last clearfix">
					  ...
					  <p><i class="fa fa-map-marker"></i>Banglore</p><br>
					  <h6><i class="fa fa-hotel col_1"></i> 4 Bedrooms <span class="pull-right"><i class="fa fa-building-o col_1"></i> 3 Bathrooms</span></h6>
					  <h6><i class="fa fa-object-group col_1"></i> 620 sq ft <span class="pull-right"><i class="fa fa-gear col_1"></i> 2 Garages</span></h6><br>
					  <h5 class="bold"><a href="#">&#8377; 130,000 <span class="pull-right"><i class="fa fa-exchange"></i> <i class="fa fa-share-alt"></i> <i class="fa fa-heart-o"></i></span></a></h5>
					  <div class="feature_2m_last_i clearfix">
					...
					<div class="col-sm-4">
					 ...
					 <div class="feature_2m_last clearfix">
					  ...
					  <p><i class="fa fa-map-marker"></i>Manglore</p><br>
					  <h6><i class="fa fa-hotel col_1"></i> 4 Bedrooms <span class="pull-right"><i class="fa fa-building-o col_1"></i> 3 Bathrooms</span></h6>
					  <h6><i class="fa fa-object-group col_1"></i> 620 sq ft <span class="pull-right"><i class="fa fa-gear col_1"></i> 2 Garages</span></h6><br>
					  <h5 class="bold"><a href="#">&#8377; 130,000 <span class="pull-right"><i class="fa fa-exchange"></i> <i class="fa fa-share-alt"></i> <i class="fa fa-heart-o"></i></span></a></h5>
					  <div class="feature_2m_last_i clearfix">
  ...
  <div class="row">
   ...
   <div class="feature_2 clearfix">
    <div class="col-sm-4">
					 <div class="feature_2im clearfix">
					   	    <div class="feature_2im1 clearfix">
					     <a href="#"><img src="img/4.png" class="iw" alt="abc"></a>
					    </div>
							<div class="feature_2im2 clearfix">
							 <h6 class="mgt"><a class="bg_1" href="#">Featured</a></h6>
							 <h6 class="pull-right mgt"><a class="bg_2" href="#">For Rent</a></h6>
					 ...
					 <div class="feature_2m_last clearfix">
					  <h4 class="mgt bold"><a href="#">home1</a></h4>
   ...
   <div class="feature_o_last clearfix">
    <div class="col-sm-12">
	 <h5 class="text-center mgt"><a class="button mgt" href="listing.html">View All <i class="fa fa-long-arrow-right"></i></a></h5>
	</div>
   </div>
  </div>
 </div>
   ...
   <div class="popular_1 clearfix">
    <div class="col-sm-4">
	 <div class="popular_1i clearfix">
	  ...
	  <div class="popular_1i2 text-center clearfix">
	   <h4 class="mgt"><a  class="col" href="#">New York City</a></h4>
	...
	<div class="col-sm-8">
	 <div class="popular_1i clearfix">
	  ...
	  <div class="popular_1i2 text-center clearfix">
	   <h4 class="mgt"><a  class="col" href="#">Los Angeles</a></h4>
   ...
   <div class="popular_1 clearfix">
	<div class="col-sm-8">
	 <div class="popular_1i clearfix">
	  ...
	  <div class="popular_1i2 text-center clearfix">
	   <h4 class="mgt"><a  class="col" href="#">America</a></h4>
	...
	<div class="col-sm-4">
	 <div class="popular_1i clearfix">
	  ...
	  <div class="popular_1i2 text-center clearfix">
	   <h4 class="mgt"><a  class="col" href="#">London</a></h4>
