...
function exportTableToCSV(filename) {
 ...
 <body>
 	<div class="title">
 		<a href="index.php"><img src="back.png" style="margin-top: 20px;padding-left: 5px;"></a>
 		<p>History</p>
 	</div>
 		<a href="javascript:location.reload(true)"><img id="img1" src="refresh.png" alt="cannot display"></a>
<br/><br/>
 	<div class="history-table">	
 		<button id="print" onclick="PrintTable()">Print</button>
 		<button id="export" onclick="exportTableToCSV('history.csv')">Export</button>
