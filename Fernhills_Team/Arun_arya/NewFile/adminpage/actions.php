              ...
              <div class="card-body">
                <div class="row">			   
				 ...
				 <div class="list-group-item"><i id="status1" class='fas fa-circle '></i></div>
				   <small  id="1mgs" class="text-center"></small>
				 </div>
				...
				<div class="list-group">
				 ...
				 <small  id="2mgs" class="text-center"></small>
				 </div>
				...
				<div class="list-group">
				 ...
				 <small  id="3mgs" class="text-center"></small>
				 </div>
				...
				<!--<div><i id="status4" class='fas fa-circle ' ></i></div>-->
				 ...
				 <small  id="4mgs" class="text-center"></small>
				 </div>
                           ...
                           success: function(data){
                                     // alert(data);
									  if (data==1) {	
                                           ...
                                           update0(ele,y);
										    $(message).html('<div>Updated 0 </div>');
										  
					                         } else {
												 
                                                update1(ele,y);
					   			                $(message).html('<div>Updated 1 </div>');
