			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<li class="dropdown">
					  ...
					  <ul class="dropdown-menu drop_3" role="menu">
						<li><a href="listing.php">Sale Property</a></li>
    ...
    <div class="col-sm-9">
	 <div class="center_list_1l clearfix">
	  <div class="center_list_1li clearfix">
	   <h5 class="mgt"><a href="detail.html">Home</a>  /  Rent Property</h5>
	   <h3>Rent List</h3>
	  </div>
     ...
     if(!$result){
	    echo "Error Found!!!";
	  	...
	  	while($property_result = mysqli_fetch_assoc($result)){
			...
			$rprice = $property_result['rprice'];
			$sdeposit = $property_result['sdeposit'];
	  ...
	  ?>
		...
		<div class="col-sm-6 space_left">
						 ...
						 <div class="feature_2m_last clearfix">
						  ...
						  <h5 class="bold"><a href="detail.html">&#8377; <?php echo $rprice;?> <span class="pull-right"><img src="img/deposit.png"/><?php echo $sdeposit;?></span></a></h5>
