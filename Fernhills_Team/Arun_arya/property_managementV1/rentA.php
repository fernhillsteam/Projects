...
<head>
  ...
  <title>Rent Property Dashboard</title>
<style type="text/css">
  .card {
    position: relative;
    display: -ms-flexbox;
...
<body>
  ...
  <a href="saleA.php">Add Sale Property</a>
  <a href="rentA.php">Add Rent Property</a>
...
<span style="font-size:30px;cursor:pointer; color: white;" onclick="openNav()">&#9776; Menu</span>
    <div class="container">
      <a class="navbar-brand" href="#" target="_blank" >Madhunivas Admin Dashboard</a>
      ...
      <div class="col-md-12 card">
        <div>
          <div class="head-title">
            <h4 class="text-center">Rent Property Dashboard</h4>
            <hr>
          </div>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="rA-insert.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="title">Rent Price :</label>
              <input type="text" name="rprice" class="form-control" placeholder="Enter Price" maxlength="50"
                required>
            </div>

            <div class="form-group">
              <label for="title">Security deposit :</label>
              <input type="text" name="sdeposit" class="form-control" placeholder="Enter Price" maxlength="50"
                required>
            </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-sm-7 col-xs-6 ">
              <div id="viewrprice"></div>
            </div>
            <div class="col-sm-5 col-xs-6 tital " >
              <strong>security deposit:</strong>
            </div>
            <div class="col-sm-7 col-xs-6 ">
              <div id="viewsdeposit"></div>
            </div>
            <div class="col-sm-5 col-xs-6 tital " >
              <strong>image:</strong>
            </div>
  ...
  <div class="modal fade" id="updateModal">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="rA-update.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="title">Rent price</label>
              <input type="text" name="updaterprice" id="updaterprice" class="form-control" placeholder="Enter designation" maxlength="50"
                required>
            </div>

            <div class="form-group">
              <label for="title">security deposit</label>
              <input type="text" name="updatesdeposit" id="updatesdeposit" class="form-control" placeholder="Enter designation" maxlength="50"
                required>
            </div>
  ...
  <div class="modal fade" id="deleteModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="rA-delete.php" method="POST">
  ...
  <script>
    $(document).ready(function () {
      $('.updateBtn').on('click', function(){
        ...
        $('#updaterprice').val(data[8]);
        $('#updatesdeposit').val(data[9]);
  ...
  <script>
    $(document).ready(function () {
      $('.viewBtn').on('click', function(){
        ...
        $('#viewrprice').text(data[8]);
        $('#viewsdeposit').text(data[9]);
