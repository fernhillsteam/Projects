...
<span style="font-size:30px;cursor:pointer; color: white;" onclick="openNav()">&#9776; Menu</span>
    <div class="container">
      <a class="navbar-brand" href="#" target="_blank" >Madhunivas Dashboard</a>
        ...
        <div>
          ...
          <table class="table table-striped">
            ...
            <?php
              ...
              $sql = "SELECT * FROM rent WHERE `name`='".$name."'";
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="r-insert.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="modal fade" id="updateModal">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="r-update.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="modal fade" id="deleteModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="r-delete.php" method="POST">
