...
if(isset($_POST['sub'])){
	...
	$i="insert into rent(image,name,location,beds,bathrooms,parking,area,price,amount)values('$img','$t','$l','$b','$b1','$park','$a','$price','$amount')";
...
<html>
	...
	<a href="home1.php">rent property list</a>
	</body>
</html>
