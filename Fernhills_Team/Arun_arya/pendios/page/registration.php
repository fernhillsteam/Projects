...
<?php
 require('db.php');
    ...
    if (isset($_REQUEST['username'])) {
        ...
        $query    = "INSERT into `users` ( username, device_id , mobilenumber, email, password, create_datetime)
...
?>
    <form class="form" action="" method="post">
		...
		<input type="text" class="login-input" name="device_id" placeholder="Device ID" required>
        <input type="text" class="login-input" name="mobilenumber" placeholder="Mobile number" required>
