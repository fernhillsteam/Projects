                                 ...
                                 if(in_array($ext, $valid_ext)){
                                         // File path
                                          ...
                                          if(move_uploaded_file($_FILES['image']['tmp_name'][$index],$path)){
                                                             ...
                                                             $this->addError('upload','images Uploaded Successfully!');
															  
                                                                   }
																   else{
																	   $this->addError('notupload','images not Uploaded!');
																   }
                                           }else{
                                                     $this->addError('notvalid','images not Uploaded!');
										   }
                                      }
                             }
							 
		  }else{
			  $this->addError('count','Upload at leat 2 Or 5 images!');
		  }					 
