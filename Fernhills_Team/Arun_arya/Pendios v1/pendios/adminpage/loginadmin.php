			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
			      	...
			      	<div class="d-flex">
						...
						<div class="form-field">
			      			...
			      			<input type="text" class="form-control" id="userla" placeholder="User Name" autofocus="true" autocomplete="off">
							  <small></small>
					          </div>
			      		</div>
		            <div class="form-group mb-3">
					<div class="form-field">
		              ...
		              <input type="password" class="form-control" id="pwdla" name="password" placeholder="Password" autocomplete="off">
					  <small></small>
					          </div>
					  <input type="checkbox" onclick="myPwd('pwdla')" >Show Password
		            </div>
					
					<div class="form-group">
                    <div class="form-field">
                  <input class="form-control btn btn-primary rounded submit px-3" id= "submit1" value="Log In" type="button" >			
					</div>
					</div>
				   <div class="row">
                          <div class="col">
                          ...
                          <div class="col">
                               <p class="text-right">Log In as User!<a href="../page/login.php">&nbsp;Login</a></p>
                           </div>
                     </div>
                          ...
                          <p>If you have forgotten your password you can reset it here.</p>
                            ...
                            <div class="panel-body">
							   <form action="" method="post">
                                    ...
                                    <input class="btn  btn-primary btn-block" id= "submit2"  value="submit" type="button" >
...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></script>
 ...
 <script>
 const usernameLA = document.querySelector('#userla');
 const passwordLA = document.querySelector('#pwdla');
...
const checkUsername = () => {
    ...
    const username = usernameLA.value.trim();

    if (!isRequired(username)) {
        showError(usernameLA, 'Username cannot be blank.');
    } else if (!isBetween(username.length, min, max)) {
        showError(usernameLA);
		
    }else if (!isUsernameValid(username)) {
        showError(usernameLA, 'Please Enter Valid UserName');
		
    } else {
        showSuccess(usernameLA);
        valid = true;
    }
    return valid;
};
...
const checkUsernameReset = () => {
    ...
    if (!isRequired(usernamereset)) {
        showError(usernameLR, 'Username cannot be blank.');
