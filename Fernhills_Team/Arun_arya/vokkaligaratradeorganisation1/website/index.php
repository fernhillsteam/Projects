...
<head>
  <title>Vokkaligara Trade Organisation &mdash;</title>
  <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 text-md-right">
              ...
              <a href="../page/login.php" class="p-3">Log In</a>
            </div>
          </div>
        </div>
      </div>
      <header class="site-navbar site-navbar-target bg-secondary shadow" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="site-logo">
              <img src="vto.png" width="90px;" height="90px;" class="img-circle person" alt="Random Name">
              <a href="index.html" class="text-white">Vokkaligara Trade Organisation</a>
            </div>
            ...
            <nav class="site-navigation text-left ml-auto " role="navigation">
              <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                ...
                <li><a href="blog.html" class="nav-link">Member</a></li>
